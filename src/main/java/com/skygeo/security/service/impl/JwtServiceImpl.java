package com.skygeo.security.service.impl;
...
public class JwtServiceImpl implements JwtService {
    ...
    @Override
    public String generateTokenWithWeChatInfo(SecurityUser securityUser, WeChatUser weChatUser) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("openid", weChatUser.getOpenId());
        claims.put("nickname", weChatUser.getNickname());
        claims.put("headimgurl", weChatUser.getAvatarUrl());
